...
class PowerAssertBuiltIns private constructor(
    ...
    val literalExpressionType = literalExpressionClass.defaultTypeWithoutArguments
    val literalExpressionConstructor = literalExpressionClass.primaryConstructor()
