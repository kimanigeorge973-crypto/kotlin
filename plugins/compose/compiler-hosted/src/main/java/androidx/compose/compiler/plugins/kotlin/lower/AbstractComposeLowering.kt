...
//        context.irBuiltIns.greaterFunByOperandType
    ...
    private fun IrClass.buildStabilityPropJvm(buildGetter: Boolean): IrProperty {
        ...
        if (buildGetter) {
            this.buildStabilityGetterJvm(property, getPackageFragment())
        }
    ...
    private fun IrClass.buildStabilityGetterJvm(stabilityProp: IrProperty, parent: IrPackageFragment) {
        ...
        context.irFactory.buildFun {
            ...
            fn.annotations = listOf(hiddenDeprecatedAnnotation)
        }
    }
