...
class ClassStabilityTransformTests(useFir: Boolean) : AbstractIrTransformTest(useFir) {
            ...
            expectedTransformed = """
                ...
                class SomeFoo(val value: Int) {
                  val SomeFoo%stableprop: Int = 0
                    ...
                    get() {
                      return SomeFoo.%stable
                    }
                }
                @StabilityInferred(parameters = 0)
                class ParametrizedFoo<K> (var value: K) {
                  val ParametrizedFoo%stableprop: Int = 8
                    @Deprecated(message = "Synthetic declaration generated by the Compose compiler. Please do not use.", level = DeprecationLevel.HIDDEN)
                    get() {
                      return ParametrizedFoo.%stable
                    }
                }
                @StabilityInferred(parameters = 0)
                class CombinedUnstable<T> (val first: T, val second: ParametrizedFoo<SomeFoo>) {
                  val CombinedUnstable%stableprop: Int = 8
                    @Deprecated(message = "Synthetic declaration generated by the Compose compiler. Please do not use.", level = DeprecationLevel.HIDDEN)
                    get() {
                      return CombinedUnstable.%stable
                    }
                }
            """
        )
    ...
    fun testTransformCombinedClassWithRuntimeStableParametrizedClass() {
        ...
        """,
            ...
            @StabilityInferred(parameters = 1)
            class CombinedStable<T> (val first: T, val second: ParametrizedFoo<SomeFoo>) {
              val CombinedStable%stableprop: Int = SomeFoo.%stable or ParametrizedFoo.%stable
                @Deprecated(message = "Synthetic declaration generated by the Compose compiler. Please do not use.", level = DeprecationLevel.HIDDEN)
                get() {
                  return CombinedStable.%stable
                }
            }
        """
        )
    ...
    fun testTransformCombinedClassWithMultiplyTypeParameters() {
        ...
        """,
            ...
            class CombinedStable<T, K> (val first: T, val second: ParametrizedFoo<K>) {
              val CombinedStable%stableprop: Int = ParametrizedFoo.%stable
                @Deprecated(message = "Synthetic declaration generated by the Compose compiler. Please do not use.", level = DeprecationLevel.HIDDEN)
                get() {
                  return CombinedStable.%stable
                }
