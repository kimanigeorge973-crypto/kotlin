...
internal class SymbolLightMethodForMappedJavaCollectionStubMethod(
    ...
    private val _modifierList: PsiModifierList by lazyPub {
        object : LightModifierList(manager, language) {
            override fun getParent(): PsiElement = this@SymbolLightMethodForMappedJavaCollectionStubMethod
            ...
            override fun hasModifierProperty(name: String): Boolean =
                this@SymbolLightMethodForMappedJavaCollectionStubMethod.hasModifierProperty(name)
