...
import org.jetbrains.kotlin.light.classes.symbol.methods.SymbolLightMethodForMappedCollectionJavaStub
...
private fun createJavaUtilMapMethodWithSpecialSignature(
    ...
    method: PsiMethod,
    substitutor: PsiSubstitutor,
): SymbolLightMethodForMappedCollectionJavaStub? {
...
private fun PsiMethod.finalBridge(
    containingClass: SymbolLightClassForClassOrObject,
    substitutor: PsiSubstitutor,
): SymbolLightMethodForMappedCollectionJavaStub = wrap(containingClass, substitutor, makeFinal = true, hasImplementation = true)

private fun PsiMethod.openBridge(
    containingClass: SymbolLightClassForClassOrObject,
    substitutor: PsiSubstitutor,
): SymbolLightMethodForMappedCollectionJavaStub = wrap(containingClass, substitutor, makeFinal = false, hasImplementation = true)
