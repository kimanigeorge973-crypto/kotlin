...
public class ReflectionFactoryImpl extends ReflectionFactory {
    ...
    public KTypeParameter typeParameter(Object container, String name, KVariance variance, boolean isReified) {
        ...
        try {
            ...
            // passing a container from "light" reflection is not expected in normal cases, but better be supported
    ...
    public boolean typesEqual(TypeReference reference, KType type) {
        return TypeOfImplKt.typesEqual(reference, type);
    }
