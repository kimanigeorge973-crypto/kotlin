...
internal class JavaEnumEntriesKProperty(
    ...
    // Accessing a @PublishedApi internal stdlib function here to avoid duplicating the logic for EnumEntries implementation.
    // This function is used from the generated code, so it won't be changed/removed due to stdlib's binary compatibility guarantees.
    @Suppress("INVISIBLE_REFERENCE")
    private val result = enumEntries(enumClass.java.enumConstants)
    ...
    override fun replaceContainerForFakeOverride(
        ...
        error("Enum entries cannot be copied: $this")
