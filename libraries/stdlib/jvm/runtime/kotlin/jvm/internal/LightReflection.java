...
/**
 * This class is a copy of {@link Reflection} with some slight modifications; it serves as a facade to the "light" reflection
 * implementation. JVM back-end generates calls to static methods of this class on any reflection-using construct if the light Reflection
 * is forced.
 * <p/>
 ...
 * <ul>
 *     <li>the factory used is always {@link ReflectionFactory} that only provides "light" reflection</li>
 *     <li>there is no "light" versions of {@link Reflection#renderLambdaToString(Lambda)} and
 *     {@link Reflection#renderLambdaToString(FunctionBase)} methods</li>
 *     <li>there is no "light" version of the {@link Reflection#getOrCreateKotlinPackage(Class, String)} method, but only
 *     {@link LightReflection#getOrCreateKotlinPackage(Class)}</li>
 *     <li>there is no "light" version of the {@link Reflection#typesEqual(TypeReference, KType)} method, as it performs
 *     cross-universe reflection types comparison</li>
 *     <li>there is no "light" version of the {@link Reflection#notSupportedError()}</li>
 * </ul>
 */
