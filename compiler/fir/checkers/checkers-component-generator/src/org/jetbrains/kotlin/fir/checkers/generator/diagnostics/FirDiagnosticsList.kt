...
object DIAGNOSTICS_LIST : DiagnosticList("FirErrors") {
    ...
    val CASTS_AND_IS_CHECKS by object : DiagnosticGroup("Casts and is-checks") {
        ...
        val CAST_NEVER_SUCCEEDS by deprecationError<KtBinaryExpressionWithTypeRHS>(LanguageFeature.TurnTypeCheckWarningsIntoErrors, PositioningStrategy.OPERATOR)
