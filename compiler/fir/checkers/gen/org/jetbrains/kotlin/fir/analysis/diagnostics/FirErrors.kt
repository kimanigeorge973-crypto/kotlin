...
object FirErrors : KtDiagnosticsContainer() {
    ...
    val CAST_NEVER_SUCCEEDS: KtDiagnosticFactoryForDeprecation0 = KtDiagnosticFactoryForDeprecation0("CAST_NEVER_SUCCEEDS", TurnTypeCheckWarningsIntoErrors, SourceElementPositioningStrategies.OPERATOR, KtBinaryExpressionWithTypeRHS::class, getRendererFactory())
