...
// test.kt:16 $bar$lambda$bridged (13)
// test.kt:17 $bar$lambda$bridged (18, 12, 8)
// test.kt:11 $foo (36, 38, 36)
// test.kt:9 $A.<init> (8, 22)
// test.kt:11 $foo (43)
// test.kt:17 $bar$lambda$bridged (18)
// test.kt:23 $box$lambda$bridged (8)
// test.kt:24 $box$lambda$bridged (8, 17, 8)
// test.kt:23 $box$lambda$bridged (8)
// test.kt:17 $bar$lambda$bridged (18)
// test.kt:16 $bar$lambda$bridged (13)
// test.kt:6 $generate (4)
