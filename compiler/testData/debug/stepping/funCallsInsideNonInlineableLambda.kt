...
// test.kt:11 $box (11)
// test.kt:8 $box (4)
// test.kt:12 $box$lambda$bridged (10)
// test.kt:3 $box$lambda$bridged (28, 31)
// test.kt:12 $box$lambda$bridged (16)
// test.kt:8 $box (4, 9)
// test.kt:14 $box (8)
// test.kt:13 $box (8)
// test.kt:8 $box (4)
// test.kt:14 $box$lambda$bridged (10)
// test.kt:5 $foo2 (21, 24)
// test.kt:14 $box$lambda$bridged (16)
// test.kt:8 $box (4, 9)
// test.kt:11 $box (11, 4)
