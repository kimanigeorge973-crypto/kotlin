...
inline fun TestConfigurationBuilder.classicFrontendHandlersStep(
    init: TestStepBuilder.HandlersStepBuilder.FirstPhase<ClassicFrontendOutputArtifact, FrontendKinds.ClassicFrontend>.() -> Unit = {}
) {
...
inline fun TestConfigurationBuilder.firHandlersStep(
    init: TestStepBuilder.HandlersStepBuilder.FirstPhase<FirOutputArtifact, FrontendKinds.FIR>.() -> Unit = {}
) {
...
inline fun TestConfigurationBuilder.irHandlersStep(
    init: TestStepBuilder.HandlersStepBuilder.FirstPhase<IrBackendInput, BackendKinds.IrBackend>.() -> Unit = {}
) {
...
inline fun TestConfigurationBuilder.jvmArtifactsHandlersStep(
    init: TestStepBuilder.HandlersStepBuilder.FirstPhase<BinaryArtifacts.Jvm, ArtifactKinds.Jvm>.() -> Unit = {}
) {
...
inline fun TestConfigurationBuilder.nativeArtifactsHandlersStep(
    init: TestStepBuilder.HandlersStepBuilder.FirstPhase<BinaryArtifacts.Native, ArtifactKinds.Native>.() -> Unit = {}
) {
...
inline fun TestConfigurationBuilder.jsArtifactsHandlersStep(
    init: TestStepBuilder.HandlersStepBuilder.FirstPhase<BinaryArtifacts.Js, ArtifactKinds.Js>.() -> Unit = {}
) {
...
inline fun TestConfigurationBuilder.wasmArtifactsHandlersStep(
    init: TestStepBuilder.HandlersStepBuilder.FirstPhase<BinaryArtifacts.Wasm, ArtifactKinds.Wasm>.() -> Unit = {}
) {
...
inline fun TestConfigurationBuilder.klibArtifactsHandlersStep(
    init: TestStepBuilder.HandlersStepBuilder.FirstPhase<BinaryArtifacts.KLib, ArtifactKinds.KLib>.() -> Unit = {}
) {
