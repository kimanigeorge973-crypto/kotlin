...
import org.jetbrains.kotlin.test.directives.JvmEnvironmentConfigurationDirectives.FORCE_LIGHT_REFLECTION
...
open class JvmEnvironmentConfigurator(testServices: TestServices) : EnvironmentConfigurator(testServices) {
    ...
    override fun DirectiveToConfigurationKeyExtractor.provideConfigurationKeys() {
        ...
        register(FORCE_LIGHT_REFLECTION, JVMConfigurationKeys.FORCE_LIGHT_REFLECTION)
    }
